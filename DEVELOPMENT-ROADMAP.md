...
Batch 2 is now decomposed into [six series implementation tasks](IMPLEMENTATION-PLAN.md#series-increment-reviewable-implementation-sequence): catalog observation, browsing/curation, target-set preview, shared pack selection, verified child fulfillment and list-to-library demonstration. Catalog observation and browsing/curation now have bounded implementation evidence. Reviewed finite target sets now also have bounded implementation evidence: previews, frozen membership, independent reasons, cancellation and receipts. Shared scope inheritance, compatible pack selection and per-child/omnibus fulfillment remain next; saved wanted requests are not proof of downloadable or imported coverage. Catalog-derived series-name searches now have bounded implementation evidence through the existing source engine. Pack coverage selection, acquisition-scope inheritance and per-child fulfillment remain open.
