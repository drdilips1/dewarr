...
- **Continue your series** uses loaded series catalogs and accessible holdings to show published gaps, with either-format, ebook and audiobook filters. Catalog order is explained separately from reading progress and acquisition authority. See [Series discovery](SERIES-DISCOVERY.md) for scope and uncertainty handling.
