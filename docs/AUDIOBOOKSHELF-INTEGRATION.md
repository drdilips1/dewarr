...
Still required: actual-version ABS inventory/scanner certification; change-event handling; broader file/identifier move detection; correction undo/merge UI; repair/ignore/replacement intents; full provider provenance and catalog enrichment. File import, hardlink/layout certification and qBittorrent acquisition belong to later gates and are not established by these inventory tests.
