...
Current implementation checkpoint, September 17, 2026. This is a partial S03 delivery; the complete PRD remains active. Tests use synthetic data and real PostgreSQL. Eight actual ABS 2.36.1 native scanner/API cases now pass; see [certification evidence and limits](ABS-NATIVE-CERTIFICATION.md). Full compatibility certification remains pending.
