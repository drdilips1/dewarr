...
| S04 | Naming/inspection/review-plan foundation implemented | Destination configuration and probes; automatic matching and grouping corrections; broader media/omnibus/companion handling; hardlink/copy publication, sidecars, recovery journal and real ABS confirmation |
...
- AT-15–AT-19/AT-30: pure naming, source inspection, frozen review plans and worker generation/replay subsets verified; no actual publication, sidecars or ABS scanner boundary certification.
...
Complete S01 identity and external-side-effect contracts, the remaining S02 metadata/series/list behavior, and S03 event/correction/live-compatibility gates. See [Acquisition foundation](ACQUISITION-FOUNDATION.md), [Metadata integration](METADATA-INTEGRATION.md) and [Identity corrections](IDENTITY-CORRECTIONS.md) for implemented contracts and remaining limitations. Actual ABS certification remains required before claiming live support. Continue S04 from [Organization planning](ORGANIZATION-PLANNING.md) through destination checks, safe publication and actual ABS certification before the S05 MAM/qBittorrent vertical slice. Keep S07 list automation gated on those results.
