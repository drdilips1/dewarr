...
| S05 | Native MAM search/detail and connection/session foundation implemented and fixture verified | Live MAM account/route certification; provisional source-to-catalog mapping; qBittorrent artifact/dispatch/monitoring; complete manual acquisition and recovery gate |
